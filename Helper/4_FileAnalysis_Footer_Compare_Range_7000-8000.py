...
LOG_FILE_PATH = f'logfiles/log-compareFooter-benignFiles-with-maliciousFooters_7000-8000_{timestamp}.txt'
...
CSV_PATH = 'datashare/data_footerSignature_maliciousFiles_varyingLengths_7000-8000.csv'  # Path to CSV with patterns from benign files
DIRECTORY_PATH = '/home/cs20m039/thesis/dataset/benign'  # Directory containing malicious files
