...
MALICIOUS_INPUT_CSV = "../DataExchange/entropy_values_malicious_FirstLastBytes.csv"
BENIGN_INPUT_CSV = "../DataExchange/entropy_values_benign_FirstLastBytes.csv"
...
def compare_entropy_values_and_print_files(entropy_files_malicious, entropy_files_benign):
    ...
    for header_header, footer_header in zip(header_headers, footer_headers):
        logging.info(f"{header_header} and footer: {footer_header}")
